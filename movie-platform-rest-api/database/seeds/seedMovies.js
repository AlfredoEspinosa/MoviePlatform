...
const sampleMovies = [
  {
    ...
    synopsis:
      "A scientist discovers a way to send messages to the past, but each message alters the future in unexpected ways.",
    country: "USA",
    views: 1250000,
  ...
  },
  {
    ...
    genere: "Horror",
    synopsis:
      "A small town is haunted by voices that only appear during heavy fog, revealing buried secrets.",
    country: "UK",
    views: 870000,
  ...
  },
  {
    ...
    genere: "Drama",
    synopsis:
      "A retired mariachi revisits his past through music, reconnecting with his estranged daughter.",
    country: "Mexico",
    views: 920000,
  ...
  },
  {
    ...
    genere: "Fantasy",
    synopsis:
      "A young girl in Oaxaca discovers a jade amulet that opens portals to ancient Mesoamerican realms.",
    country: "Mexico",
    views: 780000,
  ...
  },
  {
    ...
    genere: "Romance",
    synopsis:
      "Two indie game developers fall in love while collaborating on a retro-style adventure game.",
    country: "Canada",
    views: 980000,
  ...
  },
  {
    ...
    genere: "Adventure",
    synopsis:
      "A biologist and a local guide trek through Chiapas to protect endangered jaguars from poachers.",
    country: "Mexico",
    views: 610000,
  ...
  },
  {
    ...
    genere: "Comedy",
    synopsis:
      "A failed comedian discovers a magical microphone that makes everyone laugh uncontrollably.",
    country: "Australia",
    views: 620000,
  ...
  },
  {
    ...
    genere: "Documentary",
    synopsis:
      "Explores the lives of families separated by the US-Mexico border and their stories of resilience.",
    country: "Mexico",
    views: 430000,
  ...
  },
  {
    ...
    genere: "Animation",
    synopsis:
      "A group of space-faring animals must deliver a mysterious package across the galaxy before time runs out.",
    country: "Japan",
    views: 890000,
  ...
  },
  {
    ...
    genere: "Drama",
    synopsis:
      "A young entrepreneur in Oaxaca fights to preserve traditional mezcal production against corporate interests.",
    country: "Mexico",
    views: 710000,
